...
const sampleEntries: DistEntry[] = [
  { name: "Helm of Glory", pct: 45.5, quality: "EPIC", icon_url: "https://render.worldofwarcraft.com/us/icons/56/inv_helmet_154.jpg" },
  { name: "Crown of Valor", pct: 30.2, quality: "RARE" },
  { name: "Basic Hood", pct: 15.8, quality: "UNCOMMON" },
]
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Compact list of item/enchant distribution entries with name, optional icon, quality color, and usage percentage.",
      },
    },
    layout: "centered",
  },
...
export const WithoutIcons: Story = {
  ...
  parameters: {
    docs: { description: { story: "Entries without icon URLs." } },
  },
}
