...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'SVG donut chart showing spec presence in the PvP meta with an interactive legend. Small slices are grouped into "Other".',
      },
    },
    layout: "centered",
  },
...
export const FewSlices: Story = {
  args: {
    slices: sampleSlices.slice(0, 2),
  },
  parameters: {
    docs: {
      description: {
        story: "Only two specs — larger donut arcs.",
      },
    },
  },
}
...
export const WithOtherBucket: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Small slices grouped into "Other".',
      },
    },
  },
}
