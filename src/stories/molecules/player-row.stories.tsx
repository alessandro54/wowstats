...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Player card row with tooltip showing name, realm, rating, W/L, win rate, and region badge.",
      },
    },
    layout: "padded",
  },
...
export const Default: Story = {
  args: { player: samplePlayer, index: 0 },
}

export const WithAvatar: Story = {
  args: {
    player: { ...samplePlayer, avatar_url: "https://render.worldofwarcraft.com/us/icons/56/classicon_shaman.jpg" },
    index: 2,
  },
  parameters: { docs: { description: { story: "Player with an avatar image." } } },
}

export const EUPlayer: Story = {
  args: {
    player: { ...samplePlayer, name: "Whaazz", region: "eu", realm: "Outland", class_slug: "rogue" },
    index: 5,
  },
}
