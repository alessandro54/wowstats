...
function makeEntry(specName: string, tier: MetaBarEntry["tier"], normPct: number, color: string, iconUrl?: string): MetaBarEntry {
  return {
...
const entries: MetaBarEntry[] = [
  makeEntry("Arms Warrior", "S", 100, "#c79c6e", "https://render.worldofwarcraft.com/us/icons/56/ability_warrior_savageblow.jpg"),
  makeEntry("Frost Mage", "S", 88, "#69ccf0", "https://render.worldofwarcraft.com/us/icons/56/spell_frost_frostbolt02.jpg"),
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Table view of specs in the PvP meta showing rank, tier badge, inline meta bar, rating, win rate, and presence.",
      },
    },
    layout: "padded",
  },
...
export const FewEntries: Story = {
  ...
  parameters: { docs: { description: { story: "Only two specs." } } },
}
