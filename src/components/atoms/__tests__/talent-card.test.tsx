...
describe("talentCard", () => {
  ...
  it("applies class-color gradient when classSlug is provided", () => {
    const { container } = render(
      <TalentCard classSlug="warrior">content</TalentCard>,
    )
  ...
  it("merges custom className", () => {
    const { container } = render(
      <TalentCard className="custom-class">content</TalentCard>,
    )
  ...
  it("merges custom style prop", () => {
    const { container } = render(
      <TalentCard style={{ backfaceVisibility: "hidden" }}>content</TalentCard>,
    )
    const section = container.querySelector("section")!
