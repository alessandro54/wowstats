...
export const WithRichContent: Story = {
  args: {
    side: "top",
    align: "center",
    children: <button className="hover:bg-muted rounded border px-3 py-1.5">Talent Info</button>,
    content: (
      <div className="space-y-1">
        <div className="font-semibold">Mortal Strike</div>
        <div className="text-muted-foreground text-xs">Usage: 74.2%</div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Tooltip can contain rich content including multiple lines, formatting, and nested elements.",
      },
    },
  },
  render: (args) => (
