...
const smallTree: MetaTalent[] = [
  ...
  makeTalent(4, "Colossus Smash", 92.5, {
    row: 2,
    col: 1,
    prereqs: [
      2,
...
const wideTree: MetaTalent[] = [
  makeTalent(10, "Root Ability", 99.1, {
    row: 0,
    col: 2,
  }),
  makeTalent(11, "Talent A", 95.0, {
    row: 1,
    col: 0,
    prereqs: [
      10,
...
export const SmallTree: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Minimal 6-node tree with branching and merging edges.",
      },
    },
  },
}
...
export const WithBudget: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Budget mode highlights top nodes as BIS and remaining as Situational. Shows the legend.",
      },
    },
  },
}
...
export const WideTree: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Larger 9-node tree with 5 columns and BIS budget.",
      },
    },
  },
}
...
export const FullOpacity: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "All nodes at full opacity — used for hero talent sub-trees. Only choice percentages shown.",
      },
    },
  },
}
