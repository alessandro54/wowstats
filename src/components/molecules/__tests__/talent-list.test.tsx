...
function makeTalent(id: number, name: string, pct: number, iconUrl: string | null = null): MetaTalent {
  return {
    id, talent: { id, blizzard_id: id + 5000, name, description: null, talent_type: "spec", spell_id: null, node_id: id, display_row: null, display_col: null, max_rank: 1, default_points: 0, icon_url: iconUrl, prerequisite_node_ids: [] },
